class Validator{
    ...
    // verifica se um input passou do número máximo de caracteres
    ...
    // valida se o input só aceita letras
    ...
    printMessage(input, msg){
        ...
        //verifica a quantidade de erros presentes no input
    ...
    // verifica se o input é obrigatório (requerido)
    required(input){
        let inputValue = input.value;
    ...
    passwordvalidate(input){
        // explodir string em um array //pelo menos uma letra maiuscula e um numero
